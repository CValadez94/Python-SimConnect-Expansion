...
class AircraftEvents():
	...
	class __Avionics(EventHelper):
		list = [
            ...
            (b'AVIONICS_MASTER_1_ON', "Sets avionics master 1 switch to on", "All aircraft"),
            (b'AVIONICS_MASTER_1_OFF', "Sets avionics master 1 switch to off", "All aircraft"),
            (b'AVIONICS_MASTER_1_SET', "Sets avionics master 1switch to on or off", "All aircraft"),
            (b'AVIONICS_MASTER_2_ON', "Sets avionics master 2 switch to on", "All aircraft"),
            (b'AVIONICS_MASTER_2_OFF', "Sets avionics master 2 switch to off", "All aircraft"),
            (b'AVIONICS_MASTER_2_SET', "Sets avionics master 2 switch to on or off", "All aircraft"),
